            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li><a href="{{route('home.showHome')}}">Home<i class="ti-arrow-right"></i></a></li>
                        ...
                        @foreach($products as $key => $product)
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-product">
                                    <div style="height: 300px;width: 250px" class="product-img">
                                        <a>
                                        ...
                                        <div class="button-head">
                                            ...
                                            <div class="product-action-2">
                                                <button data-toggle="modal" data-target="#exampleModal{{$key}}"
                                                        value="{{$product->id}}" class="btn btn-outline-light"
                                                        title="Add to cart" href="#">Add to cart
                                                </button>
                                            </div>
                                        </div>
                                    </div>
    ...
    @foreach($products as $key => $product)
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="input-number" id="quantity{{$key}}"
                                                   name="quantity{{$key}}" data-min="1" data-max="1000" value="1">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-footer">
                        <h5>Add to cart success...@for($i=0;$i<30;$i++) &nbsp @endfor</h5>
        ...
        <script>
            ...
            var addToCart = function (product_id) {
                let total = $('.total-count').text();
                let quantity = $('#quantity{{$key}}').val();
                let user_id = @if(\Illuminate\Support\Facades\Session::has('login'))
                    {{\Illuminate\Support\Facades\Auth::user()->id}}
                    @else
                    0
                @endif
                var cart = {user_id, product_id, quantity};
                $('.total-count').text(Number(total) + Number(quantity));
